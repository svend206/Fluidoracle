...
function ChatMessage({ message }) {
  ...
  const handleCopyReport = async () => {
    ...
    const text = `# Fluidoracle — Technical Report\n# Vendor-Neutral AI Engineering Consultation\n\n${message.full_report}\n\n---\n_Generated by Fluidoracle • fluidoracle.com • Vendor-Neutral AI Consulting_`
    try {
...
<html><head><title>Fluidoracle Technical Report</title>
<style>
...
<div class="header">
  <h1>Fluidoracle Technical Report</h1>
  <div class="date">${dateStr}</div>
  <div class="date">Vendor-Neutral AI Engineering Consultation</div>
</div>
${reportHTML}
<div class="footer">
  <p>Generated by Fluidoracle &bull; fluidoracle.com &bull; Independent &amp; Vendor-Neutral</p>
    ...
    return (
      <div className="flex-1 flex items-center justify-center text-gray-500">
        <div className="text-center max-w-md px-6">
          ...
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Engineering Consultation</h3>
          ...
          <div className="flex items-center justify-center h-full text-gray-400">
            <div className="text-center max-w-sm">
              <p className="text-sm font-medium text-gray-600 mb-1">
                Describe your application or problem
              </p>
          ...
          <textarea
            ...
            placeholder={
              session.messages.length === 0
                ? 'Describe your application or the problem you\'re trying to solve...'
                : session.phase === 'gathering'
...
export default function ConsultPage({ verticalId = null }) {
  ...
  const handleNewSession = async () => {
    try {
      const session = await createConsultSession('New Consultation', verticalId)
